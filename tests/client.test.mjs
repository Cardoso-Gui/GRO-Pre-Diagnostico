...
test('pasting formatted CNPJ preserves all fourteen digits',async()=>{const f=await fixture();f.el('cnpj').selectionStart=0;f.el('cnpj').selectionEnd=0;f.el('cnpj').handlers.paste({preventDefault(){},clipboardData:{getData:()=> '19.131.243/0001-97'}});assert.equal(f.el('cnpj').value,'19131243000197');});
